<div class="sidebar">
            <div class="brand-logo">
                <a href="{{route('dashboard')}}"><img src="images/logoi.png" alt="" width="30">
                </a>
            </div>
            <div class="menu">
                <ul>
                    ...
                    <li class="logout">
                        <a href="{{route('logout')}}" data-toggle="tooltip" data-placement="right" title="Signout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
